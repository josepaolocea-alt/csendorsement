...
const PH_HOLIDAYS = new Set([
  ...
  // 2027 — Regular holidays (fixed + Easter-derived dates are confirmed)
  ...
  // 2027 — Special (non-working) days — follow the 2026 pattern; re-verify against
  // the official 2027 proclamation when released.
  ...
  '2027-11-02', // All Souls' Day (special non-working)
